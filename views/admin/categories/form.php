...
<h3><?php echo sprintf(lang('category_edit_title'), $category->title);?></h3>

<?php else: ?>
<h3><?php echo lang('category_create_title');?></h3>
...
<fieldset>
	<ol>
		<li class="even">
		<label for="title"><?php echo lang('category_title_label');?></label>
